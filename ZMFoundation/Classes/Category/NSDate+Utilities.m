...
- (BOOL) isSameHourAsDate: (NSDate *) aDate
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitHour fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitHour fromDate:aDate];
    return ((components1.month == components2.month) &&
            (components1.year == components2.year) && (components1.day == components2.day) && (components1.hour == components2.hour));
}
...
{
	NSDateComponents *components1 = [[NSDate currentCalendar] components:NSCalendarUnitWeekOfYear fromDate:self];
    components1.timeZone = [NSTimeZone localTimeZone];
	NSDateComponents *components2 = [[NSDate currentCalendar] components:NSCalendarUnitWeekOfYear fromDate:aDate];
    components2.timeZone =[NSTimeZone localTimeZone];
